...
public:
    ...
    struct Looper { static constexpr auto Path() { return "android/os/Looper"; } };
    struct Handler { static constexpr auto Path() { return "android/os/Handler"; } };
    struct Runnable { static constexpr auto Path() { return "java/lang/Runnable"; } };
